...
public class OnboardingNavigator extends LinearLayout {
    ...
    OnFinishOnboarding onFinishOnboarding = null;

    void setOnFinishOnboarding(OnFinishOnboarding callback) {
    ...
    View[] bulletList;
    OnPageChangeRequest onPageChangeRequest = null;

    public void setOnPageChangeRequest(OnPageChangeRequest onPageChangeRequest) {
