...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (preferences.contains("wordsEachDay")) {
            wordsEachDay = (preferences.getInt("wordsEachDay", 0))/2 - 1;
        }
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                ...
                PreferenceManager.getDefaultSharedPreferences(SettingsActivity.this)
                        .edit().putInt("wordsEachDay",(i + 1)*2).apply();
                EventBus.getDefault().post(new Integer((i + 1)*2));
    ...
    private void updateVisualDifficulty(int value, TextView word_quantity, TextView  word_quantity_qualifier, SeekBar seekBar) {
        ...
        word_quantity.setText(String.valueOf((value + 1)*2));
        word_quantity_qualifier.setText(difficulty_labels[value]);
        word_quantity_qualifier.setTextColor(getResources().getColor(value > 4? R.color.difficult_level : R.color.easy_level));
    }
