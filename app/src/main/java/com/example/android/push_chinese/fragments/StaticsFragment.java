...
public class StaticsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final Record[] records = Statics.getLastRecords(getContext(), quantity);
        Record todaysRecord = records[records.length - 1];
...
//                Typeface.createFromAsset(getContext().getAssets(), "OpenSans-Semibold.ttf"));
        ...
        chart
                .setAxisBorderValues(0, maxiumValue * ((float) 1.45))
